...
\begin{itemize}[noitemsep,topsep=0pt]
    ...
    \\    \textit{ Fullstack Developer }
            ...
            \begin{itemize}[itemsep=1pt,topsep=4pt] \normalsize
                \item {ECM systems development including backend and frontend;}
                \item {IBM FileNet platform integration development;}
                \item {Documentation writing;}
                \item {Stack: Java, JavaScript, Dojo, Groovy, Spring, GWT, Git, IBM FileNet, IBM WebSphere, Confluence, JIRA.}
            \end{itemize}
